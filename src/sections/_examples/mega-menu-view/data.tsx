    ...
    children: [
      {
        ...
        items: [
          {
            title: 'Metallic processing machinery',
            path: '#', // Submenu link (e.g. "/dashboard/user/cards")
          },
          {
            title: 'Machinery for food, beverage & cereal',
            path: '#', // Submenu link (e.g. "/dashboard/user/list")
          },
          { title: 'Laser equipment', path: '#' },
          { title: 'Mould', path: '#' },
          { title: 'Textile machinery & parts', path: '#' },
    ...
    children: [
      {
        items: [
          { title: 'Foods', path: '#' },
          { title: 'Cosmetics  ', path: '/components/mega-menu' },
          { title: 'Clothes ', path: '#' },
        ],
      },
    ],
