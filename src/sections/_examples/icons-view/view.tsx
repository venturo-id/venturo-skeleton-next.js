...
const DEMO_COMPONENTS = [
  {
    ...
    component: (
      <ComponentBox>
        ...
        <Logo disabled sx={{ width: 180, height: 64 }} />
      </ComponentBox>
    ),
  },
  ...
  },
  {
    ...
    description: (
      <>
        <Link component={RouterLink} href="/components/icons/iconify">
          Check out
        </Link>{' '}
    ...
    component: (
      <ComponentBox>
        <Tooltip title="Iconify">
          <Iconify width={32} icon="solar:double-alt-arrow-up-bold-duotone" />
        </Tooltip>
        <Iconify
          width={32}
    ...
    component: (
      <ComponentBox>
        <Tooltip title="SvgColor">
          <SvgColor src={`${ASSETS_DIR}/platforms/ic-nextjs.svg`} sx={{ width: 32, height: 32 }} />
        </Tooltip>
        <SvgColor
          src={`${ASSETS_DIR}/platforms/ic-nextjs.svg`}
