...
export type TravelContactSchemaType = z.infer<typeof TravelContactSchema>;
...
export function TravelContactForm({ sx, ...other }: BoxProps) {
  const defaultValues: TravelContactSchemaType = {
    fullName: '',
    subject: '',
    email: '',
    message: '',
