...
type CharacterProps = BoxProps & {
  isFront?: boolean;
};

export function Character({ isFront = false, sx, ...other }: CharacterProps) {
  ...
  const SECONDARY_DARK = theme.vars.palette.secondary.dark;
  const SECONDARY_DARKER = theme.vars.palette.secondary.darker;
